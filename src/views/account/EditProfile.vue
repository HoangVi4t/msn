...
let imageData = null // chứa data hình ảnh và hình ảnh
let image = ref(null) // hình ảnh đã crop
let errors = ref([])
onMounted(() => {
...
// nhận dữ liệu crop ảnh
const setCroppedImageData = (data) => { //
  imageData = data
  image.value = data.imageUrl // url ảnh
}
